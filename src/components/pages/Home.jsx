...
const Home = (props) => {
 ...
 const volunteers=()=>{
  alert('Contact on 7260903487 for Volunteers');
 }

 const fundraise=()=>{
  alert('Contact on 7260903487 for Fundraise');
 }
 const donation=()=>{
  alert('Contact on 7260903487 for Donation');
 }
  return (
    <>
      ...
      <div className='donation_box'>
        ...
        <div className='fundraise_main_section'>
          <div className='box_main'>
            ...
            <div class='join_bt'>
              <Link to='/home' onClick={volunteers}>Join Now</Link>
            </div>
          </div>
          ...
          <div className='box_main box_main1'>
            ...
            <p class='lorem_text'>Lorem Ipsum generators on the Internet tend to repeat predefined</p>
            <div class='join_bt'>
              <Link to='/home' onClick={fundraise}>Join Now</Link>
            </div>
          </div>
          ...
          <div className='box_main'>
            ...
            <p class='lorem_text'>Lorem Ipsum generators on the Internet tend to repeat predefined</p>
            <div class='join_bt'>
              <Link to='/home' onClick={donation}>Join Now</Link>
            </div>
          </div>
        </div>
